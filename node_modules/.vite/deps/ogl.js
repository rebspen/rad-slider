...
var Program = class {
  constructor(gl, {
    ...
    gl.shaderSource(vertexShader, vertex8);
    gl.compileShader(vertexShader);
    if (gl.getShaderInfoLog(vertexShader) !== "") {
      console.warn(`${gl.getShaderInfoLog(vertexShader)}
Vertex Shader
${addLineNumbers(vertex8)}`);
    }
  ...
  constructor(gl, { radius = 0.5, tube = 0.2, radialSegments = 8, tubularSegments = 6, arc = Math.PI * 2, attributes = {} } = {}) {
    ...
    for (let j = 0; j <= radialSegments; j++) {
      for (let i = 0; i <= tubularSegments; i++, idx++) {
        ...
        vertex8.x = (radius + tube * Math.cos(v)) * Math.cos(u);
        vertex8.y = (radius + tube * Math.cos(v)) * Math.sin(u);
        vertex8.z = tube * Math.sin(v);
        vertices.set([vertex8.x, vertex8.y, vertex8.z], idx * 3);
        center.x = radius * Math.cos(u);
        center.y = radius * Math.sin(u);
        normal.sub(vertex8, center).normalize();
...
var Path = class {
  ...
  computeFrenetFrames(divisions = 64, closed = false) {
    ...
    tempVec37.cross(tangents[0], normal).normalize();
...
var Post = class {
  ...
  addPass({ vertex: vertex8 = defaultVertex, fragment: fragment8 = defaultFragment, uniforms = {}, textureUniform = "tMap", enabled = true } = {}) {
    uniforms[textureUniform] = { value: this.fbo.read.texture };
    const program = new Program(this.gl, { vertex: vertex8, fragment: fragment8, uniforms });
...
var GPGPU = class {
  ...
  addPass({ vertex: vertex8 = defaultVertex2, fragment: fragment8 = defaultFragment2, uniforms = {}, textureUniform = "tMap", enabled = true } = {}) {
...
var Shadow = class {
  ...
  add({
    ...
    if (mesh.depthProgram)
      return;
    if (vertex8 === defaultVertex4 && fragment8 === defaultFragment4) {
...
var AxesHelper = class extends Mesh {
  constructor(gl, {
    ...
    const program = new Program(gl, { vertex: vertex4, fragment: fragment4 });
